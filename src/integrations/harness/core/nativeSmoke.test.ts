...
it.skipIf(!provider || comparison)(
  ...
  async () => {
    ...
    const adapters = {
      muse: (await import("../providers/muse/museAdapter.ts")).museAdapter,
      devin: (await import("../providers/devin/devinAdapter.ts")).devinAdapter,
      codex: (await import("../providers/codex/codexAdapter.ts")).codexAdapter,
      copilot: (await import("../providers/copilot/copilotAdapter.ts")).copilotAdapter,
    };
...
it.skipIf(!provider || !comparison)(
  ...
  async () => {
    const adapter =
      provider === "muse"
        ? (await import("../providers/muse/museAdapter.ts")).museAdapter
        : provider === "devin"
          ? (await import("../providers/devin/devinAdapter.ts")).devinAdapter
          : provider === "codex"
            ? (await import("../providers/codex/codexAdapter.ts")).codexAdapter
            : provider === "copilot"
              ? (await import("../providers/copilot/copilotAdapter.ts")).copilotAdapter
              : undefined;
