...
vi.mock("../providers/cursor/cursorStore.ts", () => ({
...
const providers = [
{
    id: "devin",
    model: "swe-2",
    ...(await import("../providers/devin/devin.ts").then((m) => ({
  ...
  },
{
    id: "copilot",
    model: "gpt-5.4",
    ...(await import("../providers/copilot/copilot.ts").then((m) => ({
...
import { respondDevinQuestion } from "../providers/devin/devin.ts";
import { respondCopilotQuestion } from "../providers/copilot/copilot.ts";
...
import { newSession } from "../../../features/sessions/model/session.ts";
import { buildQuestionReply } from "../../../features/sessions/model/userQuestion.ts";
...
import { setDevinRuntimeMode } from "../providers/devin/devin.ts";
import { setCopilotRuntimeMode } from "../providers/copilot/copilot.ts";
