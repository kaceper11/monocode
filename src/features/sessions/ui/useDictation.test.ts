...
import type { DictationPartial, DictationSessionEvent } from "../model/dictation";
...
vi.mock("../model/dictation", async (importOriginal) => ({
  ...(await importOriginal<typeof import("../model/dictation")>()),
