import { restoreBrowserTab } from "../../sessions/model/browserWorkspace";
...
function isRetiredDeliveryFile(raw: unknown): boolean {
  ...
  if (delivery.provider !== undefined && !["azure", "azuredevops", "github", "gitlab"].includes(delivery.provider as string)) return false;
