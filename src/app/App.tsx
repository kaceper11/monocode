...
import { TerminalResourcesControl } from "../features/sessions/ui/TerminalResourcesControl";
import { footerTerminals } from "../features/sessions/model/terminalResources";
...
export default function App({
  ...
  const onStartInboxItem = useCallback(
    async (item: InboxItem, body?: string) => {
      ...
      if (item.provider === "azuredevops" || item.provider === "jira") {
        ...
        if (!session) {
          ...
          session = {
            ...
            inboxAsk: {
              ...
              ...(item.provider === "jira" || item.provider === "azuredevops" ? { site: item.site, project: item.projectName, identifier: item.identifier, account: item.account } : {}),
              description,
            },
          };
