...
import DeveloperIcon from "@hugeicons/core-free-icons/DeveloperIcon";
...
export const Developer = wrap(DeveloperIcon, "Developer");
...
export const EyeOff = wrap(EyeOffIcon, "EyeOff");
...
export const KeyRound = wrap(KeyRoundIcon, "KeyRound");
...
export const ZoomIn = wrap(ZoomInIcon, "ZoomIn");
export const ZoomOut = wrap(ZoomOutIcon, "ZoomOut");
