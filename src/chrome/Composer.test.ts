...
vi.mock("../lib/jira", async (original) => ({
  ...await original<typeof import("../lib/jira")>(),
  jiraConnected: jira.status,
}));

import { Composer, ComposerAction } from "./Composer";
import { setHarnessModels, resetHarnessModelOverlays } from "../lib/models";
import { useBrowserContextTargets, type BrowserContextTarget } from "../lib/browserContext";
